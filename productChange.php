...
<div class="d-flex justify-content-end">
            ...
            <a role="button" class="btn btn-orange mx-2" href="productAdd.php">Ajouter un produit</a>
        </div>
    <form class="" action="Controllers/productCtrl.php?action=change&id=<?= $_GET["id"] ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
            <div class="col-3"></div>
            <div class="col-6" >
                <div>
                ...
                <div>
                    <button class="input col-3 mb-4" type="submit">Modifier</button>            
                </div>
            </div>
            <div class="col-3"></div>
